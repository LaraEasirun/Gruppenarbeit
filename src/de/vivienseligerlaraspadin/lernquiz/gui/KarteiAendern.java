...
public class KarteiAendern {
    ...
    public KarteiAendern(Karteikarte karteikarte) {
        ...
        schwierigkeitComboBox.setSelectedItem(karteikarte.getSchwierigkeitsgrad());
        ...
        aendernButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                aktuelleKarteikarte.setSchwierigkeitsgrad((String) schwierigkeitComboBox.getSelectedItem());

                JOptionPane.showMessageDialog(frame, "Karteikarte wurde erfolgreich geändert!", "Änderung erfolgreich", JOptionPane.INFORMATION_MESSAGE);
                frame.dispose();
